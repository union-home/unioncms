...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("agreement_manage")}}</li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    <section class="main-content">
                                ...
                                <div class="card">
                                    <div class="card-header card-default">
                                        <div class="card-header-title">
                                            {{getTranslateByKey("agreement_list")}}
                                        </div>
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/agreement/add')}}" class="btn btn-default btn-sm">
                                                <em class="fa fa-plus"></em>
                                            </a>
                                        </div>
                                        <div class="btn-group float-right">
                                            <form action="{{url('admin/agreement')}}" method="get">
                                    ...
                                    <div class="card-body">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>#id</th>
                                                    <th>{{getTranslateByKey("agreement_title")}}</th>
                                                    <th>{{getTranslateByKey("agreement_category")}}</th>
                                            ...
                                            @foreach($agreement as $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($value->id > 1)
                                                            <a class="btn btn-teal" href="{{url('admin/agreement/edit/'.$value->id)}}">{{getTranslateByKey("common_edit")}}</a> &nbsp;&nbsp;
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                {{ $agreement->links('globals.pagination.admin',['page' => $agreement]) }}
                            </div>
                        </div>
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        location.href= "{{url('admin/agreement/delete')}}"+"/"+id
                    }
                },
                cancel: {
