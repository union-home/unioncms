...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("home_nav_add")}}</li>
        </ol>
    </div>
</div>
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="" id="post_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="path" value="" class="form-control form-control-rounded">
                                            </div>

                                            <div class="form-group ">
                                                <label>{{getTranslateByKey("common_level")}}</label>
                                                <select name="pid" class="form-control m-b">
                                                    <option value='0' >{{getTranslateByKey("common_top_nav")}}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-inline">
                                                    <div class=" radio radio-inline radio-inverse">
                                                        <input id="pre_icon_type" name="pre_icon_type" type="radio" value="css" checked >
                                                        <label for="pre_icon_type"> {{getTranslateByKey("common_icon_css_class")}} </label>
                                                    </div>

                                                    <div class=" radio radio-inline radio-inverse">
                                                        <input id="pre_icon_type2" name="pre_icon_type" type="radio" value="img">
                                            ...
                                            <div class="form-group " id="pre_icon_img_div" style="display: none;">
                                            ...
                                            <div class="form-group " id="pre_icon_css_div">
                                                <label>{{getTranslateByKey("common_pre_icon")}}</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-inline">
                                                    <div class=" radio radio-inline radio-inverse">
                                                        <input id="suf_icon_type" name="suf_icon_type" type="radio" value="css" checked >
                                                        <label for="suf_icon_type"> {{getTranslateByKey("common_icon_css_class")}} </label>
                                                    </div>
                                                    <div class=" radio radio-inline radio-inverse">
                                                        <input id="suf_icon_type2" name="suf_icon_type" type="radio" value="img">
                                            ...
                                            <div class="form-group" id="suf_icon_img_div" style="display: none;">
                                            ...
                                            <div class="form-group " id="suf_icon_css_div">
                                                <label>{{getTranslateByKey("common_suf_icon")}}</label>
                                            ...
                                            <div class="form-group ">
                                                <label>选中标识</label>
                                                <input type="text" name="selected" value="" class="form-control form-control-rounded">
                                            </div>

                                            <div class="form-group ">
                                                <label>排序（值越大，越靠前）</label>
                                                <input type="text" name="order" value="" class="form-control form-control-rounded">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-inline">
                                                    <div class=" radio radio-inline radio-inverse">
                                                        <input id="stauts" name="stauts" type="radio" value="1" checked>
                                                        <label for="stauts"> {{getTranslateByKey("common_open")}} </label>
                                                    </div>

                                                    <div class=" radio radio-inline radio-inverse">
                                                        <input id="stauts2" name="stauts" type="radio" value="0" >
    ...
    $(function () {
        ...
        $("#post_button").click(function () {
            ...
            popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
                    $.ajax({
                        "method":"post",
                        "url":"{{url('admin/menuSubmit?form=add')}}",
