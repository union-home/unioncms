...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("home_nav")}}</li>
        </ol>
    </div>
</div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-default">
                                        {{getTranslateByKey("home_nav")}}
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/menu/home/add')}}" class="btn btn-default btn-sm">
