...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("auth_list")}}</li>
        </ol>
    </div>
</div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-default">
                                        {{getTranslateByKey("auth_list")}}
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/menu/auth/add')}}" class="btn btn-default btn-sm">
                                    ...
                                    <div class="card-body">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{getTranslateByKey("auth_name")}}</th>

                                                <th>{{getTranslateByKey("common_action")}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            {{getTreeDataForAuthTable($data)}}
                                            </tbody>
                                        </table>
                                    </div>
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        location.href= "{{url('/admin/menu/auth/delete')}}"+"/"+id
                    }
                },
                cancel: {
