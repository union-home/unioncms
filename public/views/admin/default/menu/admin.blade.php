...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("admin_nav")}}</li>
        </ol>
    </div>
</div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-default">
                                        {{getTranslateByKey("admin_nav")}}
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/menu/admin/add')}}" class="btn btn-default btn-sm">
                                    ...
                                    <div class="card-body">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{getTranslateByKey("common_path")}}</th>
                                                <th>{{getTranslateByKey("common_pre_icon")}}</th>
                                                <th>{{getTranslateByKey("common_suf_icon")}}</th>
                                                <th>排序</th>
                                            ...
                                            <tbody>
                                            {{getTreeDataForTable($data,"admin")}}
                                            </tbody>
                                        </table>
                                    </div>
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        location.href= "{{url('/admin/menu/delete')}}"+"/"+id
                    }
                },
                cancel: {
