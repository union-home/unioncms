...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("advertising_list")}}</li>
        </ol>
    </div>
</div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-default">
                                        <div class="faqtitle">
                                            {{getTranslateByKey("advertising_list")}}
                                        </div>
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/advertisement/add')}}" class="btn btn-default btn-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-teal"
                                                           href="{{url('admin/advertisement/edit?id='.$value->id)}}">
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function () {
                        location.href = "{{url('/admin/advertisement/delete')}}" + "/" + id
                    }
                },
                cancel: {
