...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("notice_manage_list")}}</li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    <section class="main-content">
                                ...
                                <div class="card">
                                    <div class="card-header card-default">
                                        <div class="noticetitle">
                                            {{getTranslateByKey("notice_manage_list")}}
                                        </div>
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/notice/add')}}" class="btn btn-default btn-sm">
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($notice as $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-teal" href="{{url('admin/notice/edit/'.$value->id)}}">{{getTranslateByKey("common_edit")}}</a> &nbsp;&nbsp;
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                {{ $notice->links('globals.pagination.admin',['notice'=>$notice]) }}
                            </div>
                        </div>
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        location.href= "{{url('/admin/notice/delete')}}"+"/"+id
                    }
                },
                cancel: {
