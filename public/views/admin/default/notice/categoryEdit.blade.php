...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">{{getTranslateByKey("notice_manage_category")}}</a></li>
            <li class="breadcrumb-item active">{{getTranslateByKey("notice_manage_category_edit")}}</li>
        </ol>
    </div>
</div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="" id="post_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-inline">
                                                    <div class=" radio radio-inline radio-inverse">
                                                        <input id="icon_type" name="icon_type" type="radio" value="css" @if($data["icon_type"]=="css") checked @endif >
                                                        <label for="icon_type"> {{getTranslateByKey("common_icon_css_class")}} </label>
                                                    </div>

                                                    <div class=" radio radio-inline radio-inverse">
                                                        <input id="icon_type2" name="icon_type" type="radio" value="img" @if($data["icon_type"]=="img") checked @endif >
                                            ...
                                            <div class="form-group " id="icon_img_div" @if($data["icon_type"]=="css") style="display: none;" @endif >
                                                <label>图标</label>
                                            ...
                                            <div class="form-group " id="icon_css_div" @if($data["icon_type"]=="img") style="display: none;" @endif>
                                                <label>图标</label>
                                                <input type="text" name="icon_css" value="{{$data["icon"]}}" class="form-control form-control-rounded">
                                            </div>
    ...
    $(function () {
        ...
        $("#post_button").click(function () {
            ...
            popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
                    ...
                    $.ajax({
                        "method":"post",
                        "url":"{{url('admin/noticeSubmit?form=categoryEdit')}}",
                        ...
                        "success":function (res) {
                            ...
                            if(res.stauts==200){
                                ...
                                setTimeout(function () {
                                    location.href="{{url('admin/notice/category')}}";
                                },2000);
                            }else{
