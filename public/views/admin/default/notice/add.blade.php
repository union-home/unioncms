...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">{{getTranslateByKey("notice_manage")}}</a></li>
            <li class="breadcrumb-item active">{{getTranslateByKey("notice_manage_add")}}</li>
        </ol>
    </div>
</div>
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="" id="post_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group ">
                                                <label>{{getTranslateByKey("common_category")}} &nbsp;&nbsp; <a href="{{url('admin/notice/category')}}">{{getTranslateByKey("common_category_manage")}}</a></label>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <textarea name="seo_description" style="height: 100px;" class="form-control"></textarea>
                                            </div>
    ...
    $(function () {
        ...
        $("#post_button").click(function () {
            ...
            popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
                    ...
                    $.ajax({
                        "method":"post",
                        "url":"{{url('admin/noticeSubmit?form=add')}}",
                        ...
                        "success":function (res) {
                            ...
                            if(res.stauts==200){
                                ...
                                setTimeout(function () {
                                    location.href="{{url('admin/notice/')}}";
                                },2000);
                            }else{
