...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">货币添加</li>
        </ol>
    </div>
</div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="" id="currency_form">
                                            ...
                                            <div class="form-group ">
                                                <label>英文代码</label>
                                                <input type="text" name="code" value="" class="form-control form-control-rounded">
                                            </div>

                                            <div class="form-group ">
                                                <label>费率</label>
                                                <input type="text" name="rate" value="" class="form-control form-control-rounded">
                                            </div>

                                            <div class="form-group ">
                                                <label>符号代码</label>
                                                <input type="text" name="symbol" value="" class="form-control form-control-rounded">
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-inline">
                                                    <div class="radio radio-inline radio-success">
                                                        <input id="phone_active" type="radio" name="position" checked value="1" >
                                                        <label for="phone_active"> 前面 </label>
                                                    </div>
                                                    <div class="radio radio-inline radio-success">
                                                        <input id="phone_active1" type="radio" name="position" value="2" >
    ...
    $(function () {
        ...
        $("#currency_button").click(function () {
            ...
            popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
                    $.ajax({
                        "method":"post",
                        "url":"{{url('admin/currencySubmit?form=add')}}",
