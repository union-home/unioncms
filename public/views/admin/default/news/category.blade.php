...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">新闻类别管理</li>
        </ol>
    </div>
</div>
                                ...
                                <div class="card">
                                    <div class="card-header card-default">
                                        ...
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/content/news/category/add')}}" class="btn btn-default btn-sm">
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($category as $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-teal" href="{{url('admin/content/news/category/edit/'.$value->id)}}">{{getTranslateByKey("common_edit")}}</a> &nbsp;&nbsp;
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        location.href= "{{url('admin/content/news/category/delete')}}"+"/"+id
                    }
                },
                cancel: {
