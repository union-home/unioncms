...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">新闻添加</li>
        </ol>
    </div>
</div>
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="" id="post_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group ">
                                                <label>{{getTranslateByKey("common_category")}} &nbsp;&nbsp; <a href="{{url('admin/content/news/category')}}">{{getTranslateByKey("common_category_manage")}}</a></label>
    ...
    $(function () {
        ...
        $("#post_button").click(function () {
            ...
            popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
                    ...
                    $.ajax({
                        "method":"post",
                        "url":"{{url('admin/newsSubmit?form=add')}}",
                        ...
                        "success":function (res) {
                            ...
                            if(res.stauts==200){
                                ...
                                setTimeout(function () {
                                    location.href="{{url('admin/content/news')}}";
                                },2000);
                            }else{
