...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">编辑专辑</li>
        </ol>
    </div>
</div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="" id="post_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group ">
                                                <label>培训说明</label>
                                                {{--<div id="content" style="min-height: 345px;" class="form-control">{!! $data["content"] !!}</div>
                                                <textarea name="content" id="text1" style="display: none;"></textarea>--}}
                                                <textarea name="content"
                                                          style="width:100%;height:400px;visibility:hidden;">{!! $data["content"] !!}</textarea>
                                            </div>
        ...
        $("#post_button").click(function () {
            ...
            popup({
                type: 'load', msg: "正在请求", delay: 800, callBack: function () {
                    ...
                    $.ajax({
                        "method": "post",
                        "url": "{{url('admin/video/categoryEdit')}}",
