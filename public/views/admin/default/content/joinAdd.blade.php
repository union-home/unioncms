                                    ...
                                    <div class="card-body">
                                        <form method="post" action="" id="post_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group ">
                                                <label>职位：</label>
                                                <input type="text" name="position" value="" class="form-control form-control-rounded">
                                            </div>

                                            <div class="form-group ">
                                                <label>岗位职责：</label>
                                                <div id="description" style="min-height: 552px;" class="form-control"></div>
                                                <textarea name="description" id="text1" style="display: none;"></textarea>
                                            </div>

                                            <div class="form-group ">
                                                <label>岗位要求：</label>
                                                <div id="requirements" style="height: 352px;" class="form-control"></div>
    ...
    $(function () {
        ...
        $("#post_button").click(function () {
            ...
            popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
                    ...
                    $.ajax({
                        "method":"post",
                        "url":"{{url('admin/content/submit?form=joinAdd')}}",
