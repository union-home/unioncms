...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">文章类别管理</li>
        </ol>
    </div>
</div>
                                ...
                                <div class="card">
                                    <div class="card-header card-default">
                                        ...
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/article/category/add')}}" class="btn btn-default btn-sm">
                                    ...
                                    <div class="card-body">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{getTranslateByKey("product_superior_type_name")}}</th>
                                                <th>{{getTranslateByKey("classification_grade")}}</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-teal"
                                                           href="{{url('admin/article/category/edit/'.$value->id)}}">{{getTranslateByKey("common_edit")}}</a>
                                                        &nbsp;&nbsp;
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        location.href= "{{url('admin/article/category/delete')}}"+"/"+id
                    }
                },
                cancel: {
