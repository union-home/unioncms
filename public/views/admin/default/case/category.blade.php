...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("other_relate_case_category")}}</li>
        </ol>
    </div>
</div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-default">
                                        {{getTranslateByKey("other_relate_case_category")}}
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/case/category/add')}}" class="btn btn-default btn-sm">
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($category as $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-teal" href="{{url('admin/case/category/edit/'.$value->id)}}">{{getTranslateByKey("common_edit")}}</a> &nbsp;&nbsp;
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        location.href= "{{url('/admin/case/category/delete')}}"+"/"+id
                    }
                },
                cancel: {
