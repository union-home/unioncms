...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("other_relate_case_category_edit")}}</li>
        </ol>
    </div>
</div>
    ...
    $(function () {
        ...
        $("#post_button").click(function () {
            ...
            popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
                    ...
                    $.ajax({
                        "method":"post",
                        "url":"{{url('admin/caseSubmit?form=categoryEdit')}}",
                        ...
                        "success":function (res) {
                            ...
                            if(res.stauts==200){
                                ...
                                setTimeout(function () {
                                    location.href="{{url('admin/case/category')}}";
                                },2000);
                            }else{
