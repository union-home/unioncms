...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("other_relate_case_add")}}</li>
        </ol>
    </div>
</div>
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="" id="post_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group ">
                                                <label>{{getTranslateByKey("common_category")}} &nbsp;&nbsp; <a href="{{url('admin/case/category')}}">{{getTranslateByKey("common_category_manage")}}</a></label>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="tags" value="" class="form-control form-control-rounded">
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <textarea name="introduct" style="height: 150px;"></textarea>
                                            </div>

                                            <div class="form-group ">
                                                <label>{{getTranslateByKey("common_content")}}</label>
                                                <div id="content" style="min-height: 552px;" class="form-control"></div>
                                                <textarea name="content" id="text1" style="display: none;"></textarea>
                                            </div>
                                            <div class="form-group ">
                                                <label>{{getTranslateByKey("common_seo_keywords")}}</label>
                                                <input type="text" name="seo_keywords" value="" class="form-control form-control-rounded">
                                            </div>
                                            <div class="form-group ">
                                                <label>{{getTranslateByKey("common_seo_description")}}</label>
                                                <textarea name="seo_description" style="height: 300px;" class="form-control"></textarea>
                                            </div>
    ...
    $(function () {
        ...
        $("#post_button").click(function () {
            ...
            popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
                    ...
                    $.ajax({
                        "method":"post",
                        "url":"{{url('admin/caseSubmit?form=add')}}",
