...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{getTranslateByKey("content_roll")}}</li>
        </ol>
    </div>
</div>
                                ...
                                <div class="card">
                                    <div class="card-header card-default">
                                        <div class="blogrolltitle">
                                            {{getTranslateByKey("content_roll")}}
                                        </div>
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/blogroll/add')}}" class="btn btn-default btn-sm">
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($case as $value)
                                                <tr>
                                                    ...
                                                    <td>{{$value->id}}</td>
                                                    <td><img src="{{GetUrlByPath($value->cover)}}" style="max-height: 50px"/></td>
                                                    <td>{{$value->title}}</td>
                                                    <td>{{$value->url}}</td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-teal"
                                                           href="{{url('admin/blogroll/edit/'.$value->id)}}">
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function () {
                        location.href = "{{url('/admin/blogroll/delete')}}" + "/" + id
                    }
                },
                cancel: {
