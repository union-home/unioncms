...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">产品类别编辑</li>
        </ol>
    </div>
</div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="" id="post_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group ">
                                                <label>{{getTranslateByKey("product_superior_type_id")}}</label>
                                                <select name="pid" class="form-control form-control-rounded">
                                                    <option value="">请选择上级代理</option>
                                                    @foreach($category as $v)
                                                        <option value="{{$v['id']}}"
                                                                @if($v['id']==$data['pid']) selected @endif>{{$v['name']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
        ...
        $("#post_button").click(function () {
            ...
            popup({
                type: 'load', msg: "正在请求", delay: 800, callBack: function () {
                    ...
                    $.ajax({
                        "method": "post",
                        "url": "{{url('admin/ProductSubmit?form=categoryEdit')}}",
