                                ...
                                <div class="card">
                                    <div class="card-header card-default">
                                        ...
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/product/add')}}" class="btn btn-default btn-sm">
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($case as $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-teal" href="{{url('admin/product/edit/'.$value->id)}}">{{getTranslateByKey("common_edit")}}</a> &nbsp;&nbsp;
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        location.href= "{{url('admin/product/delete')}}"+"/"+id
                    }
                },
                cancel: {
