...
<div class="row page-header">
    <div class="col-lg-6 align-self-center ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">产品类别管理</li>
        </ol>
    </div>
</div>
                                ...
                                <div class="card">
                                    <div class="card-header card-default">
                                        ...
                                        <div class="btn-group float-right">
                                            <a href="{{url('admin/product/category/add')}}" class="btn btn-default btn-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-teal"
                                                           href="{{url('admin/product/category/edit/'.$value->id)}}">{{getTranslateByKey("common_edit")}}</a>
                                                        &nbsp;&nbsp;
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        location.href= "{{url('admin/product/category/delete')}}"+"/"+id
                    }
                },
                cancel: {
