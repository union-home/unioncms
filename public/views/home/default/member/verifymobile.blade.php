                                ...
                                <div class="col-12 mt-md-3">
                                    <div class="">
                                        <div class="userinfo-group w-100 email">
                                            ...
                                            <input class="bc-2nd-f7 d-md-inline-block d-block w-25 mt-2 border px-2 py-1" type="text" name="phone" value="" />
...
<script type="text/javascript">
    $("#post_button").click(function () {
        popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
            $.ajax({
                "method":"post",
                "url":"{{url('member/safetySubmit?form=bind_phone')}}",
    ...
    $("#send_email_button").click(function () {
        popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
            $.ajax({
                "method":"post",
                "url":"{{url('member/safetySubmit?form=send_bind_phone')}}",
                "data": new FormData($('#post_form')[0]),                    //$("#post_form").serialize(),
                "dataType":'json',
                "cache":false,
                "processData": false,
