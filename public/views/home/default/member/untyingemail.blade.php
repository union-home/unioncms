                        ...
                        <form method="post" action="" id="post_form" enctype="multipart/form-data">
                            ...
                            <div class="row px-md-5 pb-md-5 px-2 px-2">
                                <div class="col-12 mt-md-3">
                                    <div class="">
                                        <div class="userinfo-group w-100 email">
                                            ...
                                            <input class="bc-2nd-f7 d-md-inline-block d-block w-25 mt-2 border px-2 py-1" type="text" name="email" value="{{$login_user['email']}}" readonly />
                                ...
                                <div class="col-12 my-3 d-flex justify-content-md-start justify-content-around">
                                    ...
                                    <input class="save-btn py-2 px-5 bc-theme border-0 text-white" type="button" value="解除邮箱绑定" id="post_button">
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    $("#post_button").click(function () {
        popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
            $.ajax({
                "method":"post",
                "url":"{{url('member/safetySubmit?form=untying_email')}}",
    ...
    $("#send_email_button").click(function () {
        popup({type:'load',msg:"正在请求",delay:800,callBack:function(){
            $.ajax({
                "method":"post",
                "url":"{{url('member/safetySubmit?form=send_untying_email')}}",
                "data": new FormData($('#post_form')[0]),                    //$("#post_form").serialize(),
                "dataType":'json',
                "cache":false,
                "processData": false,
