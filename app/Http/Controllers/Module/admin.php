<?php
Route::group(["prefix"=>"admin", 'middleware' => 'checkIpBlacklist'], function () {
    ...
    if(is_install()){  //如果未安装程序，屏蔽所有数据表查询
        ...
        foreach ($modules_install_datas as $modules_install_data) {
            ...
            if(file_exists(dirname(__FILE__)."/".$modules_install_data->identification."/routes/admin.php")){
                include_once dirname(__FILE__)."/".$modules_install_data->identification."/routes/admin.php";
            }
